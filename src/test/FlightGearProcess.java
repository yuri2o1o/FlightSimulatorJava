...
public class FlightGearProcess extends Process {
	...
	public FlightGearProcess(String path, int inport, int outport) throws IOException {
		ProcessBuilder pb = new ProcessBuilder(path + "/bin/fgfs.exe", "--generic=socket,in,2,127.0.0.1," + outport + ",tcp,playback_small", "--generic=socket,out,2,127.0.0.1," + inport + ",tcp,playback_small", "--fdm=null");
